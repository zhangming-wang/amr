...
const camera_params_t &CameraControl::get_params() {
    return params_;
}
...
void CameraControl::load_params() {
...
void CameraControl::_set_params() {
    if (!sensor_)
        return;
...
const camera_config_t &CameraControl::get_config() {
    return config_;
}
...
void CameraControl::load_config() {
...
void CameraControl::_set_config() {
    if (!sensor_)
        return; // 确保摄像头已初始化
