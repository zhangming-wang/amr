...
MainWindow::MainWindow(QWidget *parent)
    ...
    connect(ui->pushButton_move_front, &QPushButton::pressed, httpClient_, &HttpClient::move_front);
    connect(ui->pushButton_move_front, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_back, &QPushButton::pressed, httpClient_, &HttpClient::move_back);
    connect(ui->pushButton_move_back, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_left, &QPushButton::pressed, httpClient_, &HttpClient::move_left);
    connect(ui->pushButton_move_left, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_right, &QPushButton::pressed, httpClient_, &HttpClient::move_right);
    connect(ui->pushButton_move_right, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_left_front, &QPushButton::pressed, httpClient_, &HttpClient::move_left_front);
    connect(ui->pushButton_move_left_front, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_right_front, &QPushButton::pressed, httpClient_, &HttpClient::move_right_front);
    connect(ui->pushButton_move_right_front, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_left_back, &QPushButton::pressed, httpClient_, &HttpClient::move_left_back);
    connect(ui->pushButton_move_left_back, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_right_back, &QPushButton::pressed, httpClient_, &HttpClient::move_right_back);
    connect(ui->pushButton_move_right_back, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_turn_left, &QPushButton::pressed, httpClient_, &HttpClient::turn_left);
    connect(ui->pushButton_turn_left, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_turn_right, &QPushButton::pressed, httpClient_, &HttpClient::turn_right);
    connect(ui->pushButton_turn_right, &QPushButton::released, httpClient_, &HttpClient::stop_move);
    connect(ui->pushButton_move_front, &QPushButton::pressed, httpClient_, &HttpClient::move_front);
    connect(ui->pushButton_move_front, &QPushButton::released, httpClient_, &HttpClient::stop_move);
