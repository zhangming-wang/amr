...
def generate_launch_description():
    ...
    rviz_config_path = os.path.join(pkg_share_dir, "config", "nav2_default_view.rviz")
        ...
        [
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(
                        get_package_share_directory("control_launch"),
                        "launch",
                        "control.launch.py",
                    )
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(
                        get_package_share_directory("lidar_launch"),
                        "launch",
                        "lidar.launch.py",
                    )
                ),
