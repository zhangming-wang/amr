...
#ifndef MOTION_STATUS_MSGS__MSG__DETAIL__SENSOR_STATUS__FUNCTIONS_H_
#define MOTION_STATUS_MSGS__MSG__DETAIL__SENSOR_STATUS__FUNCTIONS_H_
 ...
 * calls
 * motion_status_msgs__msg__SensorStatus__init().
...
/**
 * It calls
 * motion_status_msgs__msg__SensorStatus__fini()
 ...
 * motion_status_msgs__msg__SensorStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * motion_status_msgs__msg__SensorStatus__Sequence__fini()
 * on the array,
...
#endif  // MOTION_STATUS_MSGS__MSG__DETAIL__SENSOR_STATUS__FUNCTIONS_H_
