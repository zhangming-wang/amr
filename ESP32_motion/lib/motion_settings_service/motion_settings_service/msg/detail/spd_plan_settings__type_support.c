...
static rosidl_typesupport_introspection_c__MessageMember motion_settings_service__msg__SpdPlanSettings__rosidl_typesupport_introspection_c__SpdPlanSettings_message_member_array[9] = {
  {
    "milliseconds",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motion_settings_service__msg__SpdPlanSettings, min_v),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motion_settings_service__msg__SpdPlanSettings, min_w),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
