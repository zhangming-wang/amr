...
void ESP32Cam::load_config() {
    ...
    // 数_据引脚配置
    config_.pin_d0 = 5;  // D0
    config_.pin_d1 = 18; // D1
    config_.pin_d2 = 19; // D2
    config_.pin_d3 = 21; // D3
    config_.pin_d4 = 36; // D4
    config_.pin_d5 = 39; // D5
    config_.pin_d6 = 34; // D6
    config_.pin_d7 = 35; // D7
    ...
    config_.pin_href = 23;
    config_.pin_sccb_sda = 26; // SDA
    config_.pin_sccb_scl = 27; // SCL
    config_.pin_pwdn = 32;
    config_.pin_reset = -1;
    ...
    config_.xclk_freq_hz = preferences_.getInt("xclk_freq_hz", 20000000);
    ...
    config_.frame_size = static_cast<framesize_t>(preferences_.getInt("frame_size", FRAMESIZE_240X240)); // FRAMESIZE_UXGA
    config_.jpeg_quality = preferences_.getInt("jpeg_quality", 15);
    config_.fb_count = preferences_.getInt("fb_count", 2);
    if (psramFound()) {
        // 打印PSRAM总大小
